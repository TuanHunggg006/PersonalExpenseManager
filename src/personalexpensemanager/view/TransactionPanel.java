...
public class TransactionPanel extends JPanel {
    ...
    public TransactionPanel(TransactionManager manager, MainFrame parent) {
        ...
        JButton btnThu = createTabButton("THU TIỀN", false);
        tabWrapper.add(btnChi); tabWrapper.add(btnThu);

        // 3. Khung NHẬP TIỀN viền xanh
        ...
        // 4. Panel chọn Thanh toán và Ngày
        ...
        // 5. GRID HẠNG MỤC DỌC (Gradient & Bo góc)
        ...
        // 6. NÚT LƯU GIAO DỊCH (Bé lại & Bo góc)
